      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <motion.div initial={{ opacity: 0, x: -24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}
            ...
            <p className="text-[#0d0d0d]/45 text-sm leading-relaxed mb-10 max-w-sm" style={{ fontFamily: "var(--font-inter), sans-serif" }}>
            ...
            <div className="space-y-5 mb-10">
              {[
                ...
                <div key={label} className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-[10px] text-[#0d0d0d]/30 tracking-wide mb-0.5 font-semibold uppercase"
                      style={{ fontFamily: "var(--font-inter), sans-serif" }}>{label}</div>
                    <div className="text-sm text-[#0d0d0d]/65 font-medium"
                      style={{ fontFamily: "var(--font-inter), sans-serif" }}>{val}</div>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="inline-flex items-center gap-2.5 px-4 py-2.5 rounded-full border border-black/[0.07] bg-white w-fit">
              ...
              <span className="text-xs text-[#0d0d0d]/50 font-medium" style={{ fontFamily: "var(--font-inter), sans-serif" }}>
          ...
          <motion.div initial={{ opacity: 0, x: 24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.1 }}>
            {sent ? (
              <div className="min-h-[520px] flex flex-col items-center justify-center text-center rounded-3xl border border-emerald-200 bg-emerald-50 p-12">
                ...
                <p className="text-[#0d0d0d]/45 text-sm max-w-xs" style={{ fontFamily: "var(--font-inter), sans-serif" }}>
              ...
              <form onSubmit={handleSubmit} className="bg-white rounded-3xl border border-black/[0.07] p-8 md:p-10 space-y-5 shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={f.id}>
                      <label className="block text-[10px] font-bold tracking-[0.18em] uppercase text-[#0d0d0d]/35 mb-2"
                        style={{ fontFamily: "var(--font-inter), sans-serif" }}>{f.label}</label>
                      <input type={f.type} name={f.id} placeholder={f.ph} required
                        className="w-full px-4 py-3.5 rounded-xl bg-[#F0EEE9] border border-black/[0.07] text-[#0d0d0d] text-sm placeholder-[#0d0d0d]/25 focus:outline-none focus:border-[#17184B]/30 focus:bg-white transition-all"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] font-bold tracking-[0.18em] uppercase text-[#0d0d0d]/35 mb-2"
                      style={{ fontFamily: "var(--font-inter), sans-serif" }}>Company</label>
                  ...
                  <div>
                    <label className="block text-[10px] font-bold tracking-[0.18em] uppercase text-[#0d0d0d]/35 mb-2"
                      style={{ fontFamily: "var(--font-inter), sans-serif" }}>Budget Range</label>
                    <select name="budget" className="w-full px-4 py-3.5 rounded-xl bg-[#F0EEE9] border border-black/[0.07] text-[#0d0d0d]/60 text-sm focus:outline-none focus:border-[#17184B]/30 transition-all appearance-none"
                      style={{ fontFamily: "var(--font-inter), sans-serif" }}>
                ...
                <div>
                  <label className="block text-[10px] font-bold tracking-[0.18em] uppercase text-[#0d0d0d]/35 mb-3"
                    style={{ fontFamily: "var(--font-inter), sans-serif" }}>Services Needed</label>
                ...
                <div>
                  <label className="block text-[10px] font-bold tracking-[0.18em] uppercase text-[#0d0d0d]/35 mb-2"
                    style={{ fontFamily: "var(--font-inter), sans-serif" }}>Tell Us About Your Project</label>
